...
var pickup_weapon = 
[
    get_object_idx('모조된 유다 피의 포옹'), 
    get_object_idx('드라큘라 (상)'),
    get_object_idx('드라큘라 (중)'),
    get_object_idx('드라큘라 (하)'),
    //
    get_object_idx('발뭉'),
    get_object_idx('허무의 칼날'),
    get_object_idx('반역장 태도 11식'),
    get_object_idx('2nd 성유물'),
    get_object_idx('헤카톤케일 프로토타입'),
    get_object_idx('유미르의 팔'),
    get_object_idx('세실리아 샤나이트 (상)'),
    get_object_idx('세실리아 샤나이트 (중)'),
    get_object_idx('세실리아 샤나이트 (하)'),
    get_object_idx('케플러 (상)'),
    get_object_idx('케플러 (중)'),
    get_object_idx('케플러 (하)'),
    get_object_idx('클레오파트라 (상)'),
    get_object_idx('클레오파트라 (중)'),
    get_object_idx('클레오파트라 (하)'),
